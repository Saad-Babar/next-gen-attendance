...
function SupAdmin() {
  ...
  const updateUser = async () => {
    ...
    try {
      ...
      // Update empdata document if it exists
      try {
        const empdataRef = doc(db, 'empdata', editingUser.empId);
        await updateDoc(empdataRef, updateData);
      } catch (empError) {
        console.log('Empdata document not found or update failed:', empError);
      }
